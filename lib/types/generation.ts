...
export interface UserRequirements {
  ...
  language: 'zh-CN' | 'en-US' | 'ja-JP' | 'ru-RU' | 'ar-SA'; // Course language - critical for generation
...
export interface SceneOutline {
  ...
  order: number;
  language?: 'zh-CN' | 'en-US' | 'ja-JP' | 'ru-RU' | 'ar-SA'; // Generation language (inherited from requirements)
