...
(All generated content must strictly use the requested course language, such as Chinese for zh-CN, English for en-US, Japanese for ja-JP, Russian for ru-RU, and Arabic for ar-SA)
