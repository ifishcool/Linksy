  ...
  (
    ...
    return (
      <div
        ...
        className={cn(
          'bg-[#fff8db] border-l-[5px] border-slate-900/80 flex flex-col shrink-0 z-20 relative overflow-visible',
          className,
        )}
      >
        {/* Drag handle */}
        ...
        <div className={cn('flex flex-col w-full h-full overflow-hidden', collapsed && 'hidden')}>
          ...
          >
            ...
            <div className="h-11 flex items-center gap-1.5 shrink-0 mt-2.5 mb-1 px-3">
              <TabsList
                variant="line"
                className="h-full flex-1 w-0 rounded-xl border-[4px] border-slate-900/70 bg-white px-1"
              >
                <TabsTrigger
                  value="lecture"
              ...
              {onCollapseChange && (
                <button
                  ...
                  className="w-8 h-8 shrink-0 rounded-xl flex items-center justify-center bg-white text-sky-600 border-[4px] border-slate-900/70 hover:bg-sky-50 hover:text-sky-700 active:scale-90 transition-all duration-200"
                >
