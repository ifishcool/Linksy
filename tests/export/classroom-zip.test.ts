      ...
      scenes: [
        {
          ...
          title: 'Intro',
          order: 0,
          content: { type: 'slide', canvas: { id: 's1', elements: [] } } as unknown as ClassroomManifest['scenes'][number]['content'],
          actions: [{ id: 'a1', type: 'speech', text: 'Welcome', audioRef: 'audio/a1.mp3' } as unknown as SpeechAction],
        },
      ],
      mediaIndex: {
